            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="tp-business__left-thumb text-center text-lg-start">
                        <img class="mb-30" style="width:380px;" src="{{asset('12step.png')}}" alt="">
                        <img class="mb-30" style="width:380px;" src="{{asset('23step.png')}}" alt="">
                        <img class="mb-30" style="width:380px;" src="{{asset('step45.png')}}" alt="">
                        <img class="mb-30" style="width:380px;" src="{{asset('step56.png')}}" alt="">
                            ...
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Conoce un poco más acerca de nuestra metodologia de trabajo</h5>
                                        <p>En Programmasters, nos enorgullece nuestro proceso detallado y centrado en el cliente, que abarca desde la primera reunión hasta la entrega final, garantizando el éxito de tu proyecto. Este es un vistazo a nuestro flujo de trabajo:</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Reunión Inicial</h5>
                                        <p>Comenzamos con una reunión con el cliente para entender tus necesidades, objetivos y expectativas. Esta es nuestra oportunidad para conocernos.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content active d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Definición de Requisitos</h5>
                                        <p>A partir de nuestra primera conversación, creamos una lista exhaustiva de requisitos para tu proyecto, un paso esencial para comprender tus necesidades y planificar eficazmente el desarrollo.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Elaboración de la Propuesta</h5>
                                        <p>Con los requisitos claramente definidos, presentamos una propuesta detallada que incluye un plan de proyecto, un cronograma y un presupuesto. Nuestro objetivo es ofrecerte una visión clara de cómo podemos ayudarte a alcanzar tus objetivos.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Etapa de Desarrollo</h5>
                                        <p>Una vez aprobada la propuesta, nos sumergimos en el desarrollo de tu proyecto. Utilizamos las mejores prácticas y tecnologías para asegurar que tu proyecto sea de alta calidad y funcione sin problemas en todas las plataformas.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Revisión y Aprobación</h5>
                                        <p>A medida que avanzamos, te mostramos los avances y solicitamos tu feedback. Este proceso de revisión y aprobación nos permite ajustar el proyecto según tus necesidades y expectativas, garantizando que el resultado final cumpla con tus requisitos.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-business__content d-flex align-items-start">
                                    ...
                                    <div class="tp-business__content-text">
                                        <h5 class="tp-business__content-title">Lanzamiento y Soporte</h5>
                                        <p>Finalmente, lanzamos tu proyecto al mundo. Ofrecemos soporte post-lanzamiento para asegurarnos de que todo funcione sin problemas y para resolver cualquier problema que pueda surgir.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="align-self-center col-xl-12 col-lg-12 tp-business__content d-flex align-items-center justify-content-center mt-40 flex-column">
                    <div class="tp-business__content-text">
                        <h5 class="tp-business__content-title text-center">¿Listo para llevar tu proyecto al siguiente nivel?</h5>
                        <p class="text-center">Contáctanos y descubre cómo Programmasters puede ayudarte a lograr tus grandes metas.</p>
                    </div>
                    <a class="tp-main-btn mb-40 mt-20" href="{{route("contacto")}}">Hablemos— Envianos un mensaje
                        <i>
